...
<div class="section" id="user-section">
    ...
    <div id="user-detail">
        ...
        <div id="user-info">
            ...
            <span id="user-role">({{ Auth::guard('karyawan')->user()->kode_pelanggan }})</span>
        </div>
    </div>
</div>
            ...
            <div class="col-3">
                <div class="card">
                    <div class="card-body text-center" style="padding: 12px 12px !important; line-height: 0.8rem">
                        ...
                        <ion-icon name="person-add-outline" style="font-size: 1.6rem;" class="text-primary mb-1"></ion-icon>
                        <br>
                    ...
                    <li>
                        <div class="item">
                            <div class="icon-box bg-primary">
                                ...
                                {{-- kalau mau edit jadi foto bisa open yang sintaks img src --}}
                            </div>
                            <div class="in">
